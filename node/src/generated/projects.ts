...
export interface FallbackMessage {
  message: string;
  type: FallbackMessage_Type;
}

export enum FallbackMessage_Type {
  CHAT = 0,
  EMAIL = 1,
  VOICE = 2,
  UNRECOGNIZED = -1,
...
export function fallbackMessage_TypeFromJSON(object: any): FallbackMessage_Type {
  switch (object) {
    case 0:
    case "CHAT":
...
export function fallbackMessage_TypeToJSON(object: FallbackMessage_Type): string {
  switch (object) {
