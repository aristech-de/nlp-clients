...
function createBaseGetContentRequest(): GetContentRequest {
  return {
    ...
    filters: [],
    chatId: "",
    includeUnpublishedIntents: false,
  };
}
...
export const GetContentRequest: MessageFns<GetContentRequest> = {
  encode(message: GetContentRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.includeUnpublishedIntents !== false) {
      writer.uint32(64).bool(message.includeUnpublishedIntents);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.includeUnpublishedIntents = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetContentRequest {
    return {
      ...
      includeUnpublishedIntents: isSet(object.includeUnpublishedIntents)
        ? globalThis.Boolean(object.includeUnpublishedIntents)
        : false,
    };
  },
  ...
  toJSON(message: GetContentRequest): unknown {
    ...
    if (message.includeUnpublishedIntents !== false) {
      obj.includeUnpublishedIntents = message.includeUnpublishedIntents;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetContentRequest>, I>>(object: I): GetContentRequest {
    ...
    message.includeUnpublishedIntents = object.includeUnpublishedIntents ?? false;
    return message;
  },
};
...
export const ContentResponseItem: MessageFns<ContentResponseItem> = {
  encode(message: ContentResponseItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.matchedInputs !== 0) {
      writer.uint32(48).int32(message.matchedInputs);
    }
    if (message.matchedKeyword !== undefined) {
      Keyword.encode(message.matchedKeyword, writer.uint32(58).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.matchedInputs = reader.int32();
          continue;
        }
        case 7: {
          if (tag !== 58) {
          ...
          message.matchedKeyword = Keyword.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ContentResponseItem {
    return {
      ...
      fallbackMessages: globalThis.Array.isArray(object?.fallbackMessages)
        ...
        : [],
      matchedInputs: isSet(object.matchedInputs) ? globalThis.Number(object.matchedInputs) : 0,
      matchedKeyword: isSet(object.matchedKeyword) ? Keyword.fromJSON(object.matchedKeyword) : undefined,
    };
  },
  ...
  toJSON(message: ContentResponseItem): unknown {
    ...
    if (message.matchedInputs !== 0) {
      obj.matchedInputs = Math.round(message.matchedInputs);
    }
    if (message.matchedKeyword !== undefined) {
      obj.matchedKeyword = Keyword.toJSON(message.matchedKeyword);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ContentResponseItem>, I>>(object: I): ContentResponseItem {
    ...
    message.matchedInputs = object.matchedInputs ?? 0;
    message.matchedKeyword = (object.matchedKeyword !== undefined && object.matchedKeyword !== null)
      ? Keyword.fromPartial(object.matchedKeyword)
      : undefined;
    return message;
  },
};
...
function createBaseGetKeywordsRequest(): GetKeywordsRequest {
  return { projectId: "" };
}

export const GetKeywordsRequest: MessageFns<GetKeywordsRequest> = {
  encode(message: GetKeywordsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
      writer.uint32(10).string(message.projectId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetKeywordsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetKeywordsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetKeywordsRequest {
    return { projectId: isSet(object.projectId) ? globalThis.String(object.projectId) : "" };
  },

  toJSON(message: GetKeywordsRequest): unknown {
    const obj: any = {};
    if (message.projectId !== "") {
      obj.projectId = message.projectId;
    }
  ...
  create<I extends Exact<DeepPartial<GetKeywordsRequest>, I>>(base?: I): GetKeywordsRequest {
    return GetKeywordsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetKeywordsRequest>, I>>(object: I): GetKeywordsRequest {
    const message = createBaseGetKeywordsRequest();
    message.projectId = object.projectId ?? "";
    return message;
  },
...
function createBaseGetKeywordsResponse(): GetKeywordsResponse {
  return { keyword: undefined, id: "" };
}

export const GetKeywordsResponse: MessageFns<GetKeywordsResponse> = {
  encode(message: GetKeywordsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.keyword !== undefined) {
      Keyword.encode(message.keyword, writer.uint32(10).fork()).join();
    }
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetKeywordsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetKeywordsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetKeywordsResponse {
    return {
  ...
  toJSON(message: GetKeywordsResponse): unknown {
    const obj: any = {};
    if (message.keyword !== undefined) {
  ...
  create<I extends Exact<DeepPartial<GetKeywordsResponse>, I>>(base?: I): GetKeywordsResponse {
    return GetKeywordsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetKeywordsResponse>, I>>(object: I): GetKeywordsResponse {
    const message = createBaseGetKeywordsResponse();
